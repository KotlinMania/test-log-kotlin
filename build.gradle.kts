...
kotlin {
    ...
    val xcf = XCFramework("TestLog")

    macosArm64 {
        binaries.framework { baseName = "TestLog"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TestLog"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TestLog"
        flattenPackage = "io.github.kotlinmania.testlog"
    }

    android {
        namespace = "io.github.kotlinmania.testlog"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "test-log-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/test-log-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/test-log-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/test-log-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTestLogXCFramework",
    "assembleTestLogDebugXCFramework",
    "assembleTestLogReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTestLogXCFramework",
    "assembleReleaseIosFatFrameworkForTestLogXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTestLogXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTestLogXCFramework",
    "assembleDebugMacosFatFrameworkForTestLogXCFramework",
    "assembleReleaseMacosFatFrameworkForTestLogXCFramework",
    "assembleDebugTvosFatFrameworkForTestLogXCFramework",
    "assembleReleaseTvosFatFrameworkForTestLogXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTestLogXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTestLogXCFramework",
    "assembleDebugWatchosFatFrameworkForTestLogXCFramework",
    "assembleReleaseWatchosFatFrameworkForTestLogXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTestLogXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTestLogXCFramework",
