...
This file is the quick-reference operating contract for test-log-kotlin. The longer
...
test-log-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`test-log`](https://crates.io/crates/test-log). Upstream Rust is the behavioral oracle while the
